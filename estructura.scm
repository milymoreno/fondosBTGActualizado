...
peticion para sucribir el fondos

Python
 post /suscribir_fondos/unique_client_id
...
peticion para cancelar el fondos

Python
post /cancelar_suscripciones/unique_client_id


{
  "fondos_a_cancelar": [
    {"fondoId": "id_del_fondo_1"},
    {"fondoId": "id_del_fondo_2"}
  ]
}
